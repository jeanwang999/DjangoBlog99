"""
Django settings for DjangoBlog99 project.
...
SECRET_KEY = "django-insecure-cmj8vsmz3m#)zu_%%6yaqsue#e27@=*1pj(++ibjfa=h-6*rg0"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True # 正式上線時 改成false

ALLOWED_HOSTS = ["*"]  # *表示我允許任何ip位置連到我的框架
...
ROOT_URLCONF = "DjangoBlog99.urls"
...
WSGI_APPLICATION = "DjangoBlog99.wsgi.application"
